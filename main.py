...
@bot.command()  # sesli konuşma desteği
async def vci(ctx, *, text=None):
    ...
    audio = discord.FFmpegPCMAudio(
        executable=(
            r"C:\Users\KILIC\Downloads\ffmpeg-2026-06-15-git-44d082edc8-full_build\ffmpeg-2026-06-15-git-44d082edc8-full_build\bin\ffmpeg.exe"
        ),
        source=audio_file
    )
